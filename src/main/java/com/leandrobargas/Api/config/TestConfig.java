package com.leandrobargas.Api.config;
...
import com.leandrobargas.Api.entities.enums.OrderStatus;
import com.leandrobargas.Api.repositories.CategoryRepository;
import com.leandrobargas.Api.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-08-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2);
